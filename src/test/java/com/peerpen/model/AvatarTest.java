...
public class AvatarTest {
    ...
    public void avatarMutatorTest(){
        Integer newID = (Integer) Manager.find("SELECT Auto_increment FROM information_schema.tables WHERE table_schema = 'peerpendb' AND table_name='avatars'").get("autoIncrement");
