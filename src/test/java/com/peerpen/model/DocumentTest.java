...
public class DocumentTest {
    ...
    public void testCreateComment() throws Exception {
        ...
        Assert.assertTrue( comment2.getMessage().contentEquals( "TestDocumentCreateComment:" + randomString ),
                "Create comment" );
        comment2.destroy();
    }
    ...
    public void testUpdate() throws Exception {
        ...
        Assert.assertEquals( document2.getDocName(), "TestDocument2:" + randomString,
                "Test save() method in Document" );
