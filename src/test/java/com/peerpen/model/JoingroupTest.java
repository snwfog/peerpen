...
public class JoingroupTest {
    ...
    public void relationTest(){
        Integer nextId = (Integer) Manager.find("SELECT Auto_increment FROM information_schema.tables WHERE table_schema = 'peerpendb' AND table_name='joingroups'").get("autoIncrement");
