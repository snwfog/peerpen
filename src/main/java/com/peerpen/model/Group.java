...
public class Group extends Taggable {
    ...
    public List<Broadcast> getOrderedBroadcast() {
        List<Broadcast> broadcasts = new Broadcast().queryAll(
                "SELECT * FROM `broadcasts` WHERE group_id= " + this.getId() + " ORDER BY last_modified_date DESC" );
        return broadcasts;
    }
    ...
    public List<Joingroup> getRequests() {
        List<Joingroup> joingroups = new Joingroup().queryAll(
                "SELECT * FROM `joingroups` WHERE group_id= " + this.getId() + " ORDER BY last_modified_date DESC" );
        return joingroups;
    }
