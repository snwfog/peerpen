...
//    }
    ...
    private void storeAvatar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//                        String fileName = sessionPeer.getId().toString() + "-" + StringUtils.lowerCase(sessionPeer.getFirstName());
//                        // Write the file
//                        largeAvatarFile = new File(MessageFormat.format("{0}/{1}/{2}/{3}.{4}"
//                                , ctx.getRealPath(""), avatarDir, LARGE_FOLDER, fileName, fileType));
