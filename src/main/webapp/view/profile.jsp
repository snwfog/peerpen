...
<div class="container">
    ...
    <div class="row profile">
        <div class="span4">
            <div class="">
                <div class="span4">
                    <p>Personal Information</p>&nbsp<a id="edit_personal" href="#"><span id="personal_icon"
                        ...
                        <div class="col-md-6">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control peerPersonal"
                                               name="dob"
                                               value="<%= sessionUser.getDateOfBirth() == null ? "" : sessionUser.getDateOfBirth().toString()%>"
                                               readonly>
                                    </td>
                                </tr>
                        ...
                        <div class="col-md-6">
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control peerPersonal"
                                               name="gender"
                                               value="<%= sessionUser.getGender() == null ? "" : sessionUser.getGender().toString() %>"
                                               readonly>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control peerPersonal"
                                               name="yoe"
                                               value="<%= sessionUser.getExperience() == 0 ? "" : sessionUser.getExperience().toString() %>"
                                               readonly>
                                    </td>
                                </tr>
                                <input type="hidden" class="form-control peerID" name="id"
                                ...
                                <input type="hidden" name="personal_website"
                                       value="<%= sessionUser.getPersonalWebsite()%>">
                            </table>
                        </div>
                    </form>
                </div>
        ...
        <div class="span3">
            <div class="">
                <div class="col-md-5">
                    <p>About Me</p>&nbsp<a id="edit_description" href="#"><span id="description_icon"
                                                                                class="glyphicon glyphicon-pencil"></span></a>
                </div>
            </div>
            <div class="well">
                <form action="/profile" id="form_description" method="post">
                    <textarea class="peerDescription well form-control" name="description" style="resize:none" rows="3"
                              readonly><%= sessionUser.getDescription().toString() %>
                    </textarea>
                    <input type="hidden" class="form-control peerID" name="id"
                           value="<%= Integer.parseInt(sessionUser.getId().toString())%>"/>
                    <input type="hidden" name="email" value="<%= sessionUser.getEmail()%>">
                    <input type="hidden" name="personal_website" value="<%= sessionUser.getPersonalWebsite()%>">
                    <input type="hidden" class="form-control peerPersonal" name="first_name"
                           value="<%= sessionUser.getFirstName().toString() %>">
                    <input type="hidden" class="form-control peerPersonal" name="last_name"
                           value="<%= sessionUser.getLastName().toString() %>">
                    <input type="hidden" class="form-control peerUsername" name="user_name"
                           value="<%= sessionUser.getUserName().toString() %>">
                    <input type="hidden" class="form-control peerDoB" name="dob"
                           value="<%= sessionUser.getDateOfBirth() == null ? "" : sessionUser.getDateOfBirth().toString() %>">
                    <input type="hidden" class="form-control peerID" name="id"
                           value="<%= sessionUser.getId().toString()%>">
                    <input type="hidden" class="form-control peerPersonal" name="gender"
                           value="<%= sessionUser.getGender() == null ? "" : sessionUser.getGender().toString() %>">
                    <input type="hidden" class="form-control peerPersonal" name="country"
                           value="<%= sessionUser.getCountry().toString()%>">
                    <input type="hidden" class="form-control peerPersonal" name="industry"
                           value="<%=sessionUser.getIndustry().toString()%>">
                    <input type="hidden" class="form-control peerPersonal" name="yoe"
                           value="<%=sessionUser.getExperience().toString()%>">
        ...
        <div class="span4">
            <div class="">
                <div class="col-md-5">
                    <p>Contact Information</p>&nbsp<a id="edit_contact" href="#"><span id="contact_icon"
                                                                                       class="glyphicon glyphicon-pencil"></span></a>
                </div>
            </div>
            <div class="well">
                <form action="/profile" id="form_contact" method="post">
                    ...
                    <input type="hidden" class="form-control peerUsername" name="user_name"
                           value="<%= sessionUser.getUserName().toString() %>">
                    <input type="hidden" class="form-control peerPersonal" name="dob"
                           value="<%= sessionUser.getDateOfBirth() == null ? "" : sessionUser.getDateOfBirth().toString() %>">
                    <input type="hidden" class="form-control peerID" name="id"
                           value="<%= sessionUser.getId().toString()%>">
                    <input type="hidden" class="form-control peerPersonal" name="gender"
